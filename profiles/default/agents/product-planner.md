...
for file in mission.md roadmap.md; do
    if [ ! -f "boundless-os/product/$file" ]; then
        echo "Error: Missing $file"
    else
        echo "✓ Created boundless-os/product/$file"
    fi
done

echo "Product planning complete! Review your product documentation in boundless-os/product/"
```
