...
# =============================================================================
# Boundless OS Create Profile Script
# Creates a new profile for Boundless OS
# =============================================================================
...
main() {
    clear
    echo ""
    echo -e "${BLUE}=== Boundless OS - Create Profile Utility ===${NC}"
    echo ""
    ...
    echo "  2. Install Boundless OS in a project using this profile with: ~/boundless-os/scripts/project-install.sh --profile $PROFILE_NAME"
    echo ""
    echo -e "${GREEN}Visit the docs on customizing your profile: https://buildermethods.com/boundless-os/profiles${NC}"
    echo ""
    echo -e "${GREEN}════════════════════════════════════════════${NC}"
    echo ""
}
