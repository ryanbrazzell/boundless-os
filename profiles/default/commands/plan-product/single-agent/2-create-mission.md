Now that you've gathered information about this product, use that info to create the mission document in `boundless-os/product/mission.md` by following these instructions:
...
```
✅ I have documented the product mission at `boundless-os/product/mission.md`.
