Now that you've created this product's mission.md, use that to guide your creation of the roadmap in `boundless-os/product/roadmap.md` by following these instructions:
...
```
✅ I have documented the product roadmap at `boundless-os/product/roadmap.md`.
