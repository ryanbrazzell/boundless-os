...
- `boundless-os/specs/[this-spec]/spec.md`
...
- `boundless-os/specs/[this-spec]/spec.md` (if present)
- `boundless-os/specs/[this-spec]/planning/requirements.md` (if present)
- `boundless-os/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `boundless-os/specs/[this-spec]/tasks.md`
