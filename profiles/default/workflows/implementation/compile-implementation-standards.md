...
3. Compile the list of file references to those standards, one file reference per line, using this logic for determining which files to include:
   ...
   b. If the item under standards ends with "*" then it means that all files within this folder or sub-folder should be included. For example, `frontend/*` means include all files and sub-folders and their files located inside of `boundless-os/standards/frontend/`.
   c. If a file ends in `.md` then it means this is one specific file you must include in your list of files. For example `backend/api.md` means you must include the file located at `boundless-os/standards/backend/api.md`.
...
```
@boundless-os/standards/global/coding-style.md
@boundless-os/standards/global/conventions.md
@boundless-os/standards/global/tech-stack.md
@boundless-os/standards/backend/api/authentication.md
@boundless-os/standards/backend/api/endpoints.md
@boundless-os/standards/backend/api/responses.md
@boundless-os/standards/frontend/css.md
@boundless-os/standards/frontend/responsive.md
```
