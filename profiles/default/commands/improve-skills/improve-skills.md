...
- The Skill.md contains a link that points to `boundless_os/standards/...` — Follow that link and read its contents.
...
- You can link to other files (like your Boundless OS standards files) using markdown links.
