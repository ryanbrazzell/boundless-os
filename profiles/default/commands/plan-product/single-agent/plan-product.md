...
{{PHASE 1: @boundless-os/commands/plan-product/1-product-concept.md}}

{{PHASE 2: @boundless-os/commands/plan-product/2-create-mission.md}}

{{PHASE 3: @boundless-os/commands/plan-product/3-create-roadmap.md}}

{{PHASE 4: @boundless-os/commands/plan-product/4-create-tech-stack.md}}
